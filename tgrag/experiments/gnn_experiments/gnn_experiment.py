...
def run_gnn_baseline(
    ...
    for run in tqdm(range(model_arguments.runs), desc='Runs'):
        ...
        for _ in tqdm(range(1, 1 + model_arguments.epochs), desc='Epochs'):
            ...
            epoch_avg_preds_train.append(batch_train_preds)
            epoch_avg_targets_train.append(batch_train_targets)
            epoch_avg_preds_val.append(batch_valid_preds)
            epoch_avg_targets_val.append(batch_valid_targets)
        ...
        final_avg_preds_train.append(mean_across_lists(epoch_avg_preds_train))
        final_avg_targets_train.append(mean_across_lists(epoch_avg_targets_train))
        final_avg_preds_val.append(mean_across_lists(epoch_avg_preds_val))
        final_avg_targets_val.append(mean_across_lists(epoch_avg_targets_val))
